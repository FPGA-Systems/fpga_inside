...
HD_PWD='C:/prj/fpga-inside/srl/vivado/srl/srl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log srl_6_vhdl_attr_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source srl_6_vhdl_attr_2.tcl
